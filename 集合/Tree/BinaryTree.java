...
//		}
	 ...
	 * 中序遍历增加方法
	 * */
	public void inorder(Visitor<T> visit) {
		inorder2(root, visit);
	}
	
	private void inorder2( Node<T> node, Visitor<T> visitor) {
	...
	protected List<T> postorderTraversal() {
	...
	protected List<T> postorderTraversal2() {
